...
export const RaceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="iHateRunningApp.race.delete.question">
        <Translate contentKey="iHateRunningApp.race.delete.question" interpolate={{ id: raceEntity.id }}>
