...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './run.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RUN_LIST actions', async () => {
    ...
    it('dispatches FETCH_RUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RUN actions', async () => {
      const expectedActions = [
        {
